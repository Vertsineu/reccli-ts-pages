...
其中，位于 Rec Cloud Storage 下的文件列表就是您的 Rec 云盘文件列表，位于 PanDav WebDAV Storage 下的文件列表就是您的 Seafile 新网盘文件列表。
...
在 PanDav WebDAV Storage 下，您可以看到 Seafile 新网盘的资料库列表，根目录下的几个资料库都是个人和群组的资料库，群组资料库的名称通常以“群组资料库”结尾，如图中所示。
...
然后，选择完毕后，点击 PanDav WebDAV Storage 下您想要迁移过去的 Seafile 新网盘资料库。
...
然后，选择 PanDav WebDAV Storage 下您想要迁移过去的 Seafile 新网盘资料库，群组资料库的名称通常以“群组资料库”结尾。
...
如果您的 Seafile 新网盘中已经存放了文件/文件夹，或者由于传输失误，有部分文件夹已经存在但是没完全传输过去，您可以在 PanDav WebDAV Storage 下看到这些文件/文件夹也能被选中。
